...
def read_data(filepath="./juego_del_ahorcado/db.txt"):
    words = []
...
def run():
    data = read_data(filepath="./juego_del_ahorcado/db.txt")
    #escogemos una palabra de la base de datos
    chosen_word = random.choice(data)
    chosen_word_list = [letter for letter in chosen_word]
    #imprimimos una raya por cada letra de la palabra escogida
